...
| [Env](unity-aws-resource-tagging-conventions.md#env)                                                                                                                                 | same as [Venue](unity-aws-resource-tagging-conventions.md#venue) (see above) -- redundant MCP tag |
| [mcpBilling](unity-aws-resource-tagging-conventions.md#mcpbilling)                                                                                                                   | Kion tag used for costing                                                                         |
| [mission](unity-aws-resource-tagging-conventions.md#mission)                                                                                                                         | same as [Proj](unity-aws-resource-tagging-conventions.md#proj) (see above) -- redundant MCP tag   |
