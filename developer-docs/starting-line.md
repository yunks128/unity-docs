...
1. First you will need to confirm access to the Unity test environment. You will need to make a MCP access request to the support team if it does not already work. The core user interface will be [Jupyter](https://jupyter-test-alb-1633047587.us-west-2.elb.amazonaws.com:8000/). To understand the first-time log in experience please see the [Common Services ](common-services/unity-account-and-login.md#logging-in-for-the-first-time-test-or-development-systems)documentation.
2. Once you have Unity access set up, we suggest trying out the official Jupyter welcome tour ([https://jupyter.org/try-jupyter/lab/](https://jupyter.org/try-jupyter/lab/)) and user documentation ([https://jupyterlab.readthedocs.io/en/stable/getting\_started/overview.html](https://jupyterlab.readthedocs.io/en/stable/getting\_started/overview.html)). This will help you get familiar with the Jupyter user interface and concepts.
